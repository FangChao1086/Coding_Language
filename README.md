...
3. 所有中间节点元素都同时存在于子节点，在子节点元素中是最大元素  
...
<span id="常见面试题"></span>
# 常见面试题
* [均匀随机数发生器1-7生产出1-10](#均匀随机数发生器1-7生产出1-10)  
* [换门问题](#换门问题)  

## 均匀随机数发生器1-7生产出1-10
[参考连接](https://blog.csdn.net/a763470525/article/details/82015006)  
* 方法1：2进制转换法
  * 1-6： 1-3为0，4-6为1
  * 生成0000(0)， 0001(1)，...,  1111(15), 去除，仅留1-10
* 方法2：7进制产生2次
  * 1-7： 0-6
  * 2次7进制：00(0)， 01(1)，..., 66(48)， 去除，仅留0-39
  * 对10取余数 + 1
...
问题描述：  
有三扇门，有一个门后面有奖品。  
游戏规则，选手先选一个门，支持人会在另两个门中去掉一个没有奖品的门，问此时选手是否需要换门
解答：
假设门A、B、C;
奖品在A门，选手选择A门；去除的是B或者C,换门输
奖品在A门，选手选择B门；去除的是C,换门赢
奖品在A门，选手选择C门；去除的是B,换门赢
奖品在B、C门时，同样。所以换门赢的概率 2/3； 不换门赢的概率 1/3； 应该换门
```
